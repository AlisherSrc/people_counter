...
for filename in glob.glob(os.path.join(input_dir, '*.jpg')):
    ...
    for result in results[0].boxes:
        ...
        if(class_label == 0):
            ...
            cv2.putText(image_cv, labels[class_label], (int(tl[0]), int(tl[1]) - 10), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 1)
    
    cv2.putText(image_cv, "Number of people: " + str(cnt), (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 1)
